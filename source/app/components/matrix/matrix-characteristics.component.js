...
(function() {
    ...
    function renderTemplate() {
        return [
            '<div class="matrix-g matrix-g-characteristic" ng-repeat="group in :refresh:vm.listDisplay track by group.characteristicGroupId">',
                '<div class="matrix-item matrix-g-item matrix-item-content">',
                '</div>',
                '<div class="matrix-item matrix-item-content js-matrix-item-content" ng-repeat="item in :refresh:group.characteristics track by item.characteristicId" >',
                    '<div class="matrix-row">',
                        '<div class="matrix-col matrix-criteria-group" ng-repeat="decisionCol in :refresh:item.decisionsRow track by decisionCol.uuid" ng-click="vm.getComments($event)">',
                            '<div class="matrix-col-content">',
                                '<content-formater ng-if=":refresh:decisionCol.characteristics" item=":refresh:decisionCol.characteristics"></content-formater>',
    ...
    MatrixCharacteristicsController.$inject = ['DiscussionsNotificationService', '$scope'];

    function MatrixCharacteristicsController(DiscussionsNotificationService, $scope) {
        var vm = this,
