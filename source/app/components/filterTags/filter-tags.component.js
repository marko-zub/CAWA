(function() {
  ...
  function renderTemplate() {
    return [
      ...
      '<span>{{tag.characteristicName}}: {{tag.operator}}</span>',
    ...
    function removeTag(item, value) {
      ...
      if (item.value && _.isArray(item.value)) { //Checkboxes
        Utils.removeItemFromArray(value, itemCopy.value);
          ...
          if(_.isEmpty(itemCopy.queries)) itemCopy.queries = null; itemCopy.value = null;
      } else {
        itemCopy.queries = null; itemCopy.value = null;
      }
